...
2. Ответы владельца получены 24.09 (16 решений, см. «Итог опроса» в `owner-decisions.md`); открытыми
   остались B2/F10, C2, C3, C6, C11, C13, D1. Правки планов ниже делать уже без развилок по группе A.
3. **Внести правки планов из §8.1–§8.7 в текст M18–M23** `spec/18-milestones.md` и добавить M24a–M24d,
   M25–M28 (нумерация: M24a community relays = M24a.1 каталог + server-relay, M24a.2 роли relay/mailbox в клиенте; M24b Aira Onion v1, M24c мосты/обфускация, M24d mix;
